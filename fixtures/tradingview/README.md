...
| `malformed.json` | Invalid `direction`, non-ISO `barTime`, scientific-notation and non-numeric prices, negative volume | `400` synchronously (never queued), and durably stored with `processingStatus: REJECTED`, `failureCode: MALFORMED_PAYLOAD` |
